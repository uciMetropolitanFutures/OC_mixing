...
shinyUI(
  ...
  tabPanel("Mixing Values", div(class="outer",
        ...
        absolutePanel(id = "controls", class = "panel panel-default", fixed = TRUE, draggable = TRUE, top = 60, left = "auto", 
                      ...
                      p(strong(em("This application displays values of mixing and other socioeconomic conditions in 2012."))),
                      ...
                      selectInput("analysis", label="", choices=list("Mixing Type" = 1, "Socioeconomic Conditions" = 2), selected = 1),
